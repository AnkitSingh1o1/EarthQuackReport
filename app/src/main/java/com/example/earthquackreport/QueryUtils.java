...
public final class QueryUtils {
     ...
     */
    public static ArrayList<QuackReport> extractEarthquakes() {

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<QuackReport> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            for(int i = 0; i < earthquackArray.length(); i++){
                JSONObject currEarthquack = earthquackArray.getJSONObject(i);
                ...
                QuackReport earthquake = new QuackReport(magnitude, location, timeInMilliseconds, url);
